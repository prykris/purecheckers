...
<style>
  .seat{display:flex;align-items:center;gap:9px;min-width:0;height:var(--seat-height,52px);min-height:var(--seat-height,52px);box-sizing:border-box;flex:none;padding:6px 12px;position:relative;isolation:isolate;border-radius:inherit;}
  ...
  :global([data-layout=landscape]) .seat{height:100%;min-height:0;flex-direction:column;justify-content:center;text-align:center;padding:10px 5px;gap:10px;}
