...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-ChhQTXco.js')),
			__memo(() => import('./chunks/1-BbylU5rH.js')),
			__memo(() => import('./chunks/2-BwehlCsD.js')),
			__memo(() => import('./chunks/4-DbvMFt4l.js')),
			__memo(() => import('./chunks/5-CxtBZg9F.js')),
			__memo(() => import('./chunks/6-UJZvgtMv.js')),
			__memo(() => import('./chunks/7-hqw50mKP.js')),
			__memo(() => import('./chunks/8-BXwGr_u4.js')),
			__memo(() => import('./chunks/9-Da7lJG-Q.js')),
			__memo(() => import('./chunks/10-CRl0l3z6.js')),
			__memo(() => import('./chunks/11-CUEdOiSY.js')),
			__memo(() => import('./chunks/12-BqS-jvPb.js')),
			__memo(() => import('./chunks/13-uHrnyAcX.js')),
			__memo(() => import('./chunks/14-CfgwVj7R.js'))
		],
		remotes: {
...
const prerendered = new Set(["/","/blog","/changelog","/es","/strategy"]);
