const index = 10;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-DFOFtPBl.js')).default;
...
const stylesheets = ["_app/immutable/assets/RoomChat.Fa6u4rW0.css","_app/immutable/assets/10.DGGrVw_D.css"];
const fonts = [];

export { component, fonts, imports, index, stylesheets };
//# sourceMappingURL=10-CRl0l3z6.js.map
