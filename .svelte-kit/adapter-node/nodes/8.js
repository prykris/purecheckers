...
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(app)/lobby/_page.svelte.js')).default;
...
export const stylesheets = ["_app/immutable/assets/8.DVH9QvQf.css"];
export const fonts = [];
